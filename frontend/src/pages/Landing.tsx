    ...
    <section id="templates" className="py-24 px-4 bg-gradient-to-b from-transparent to-muted/40">
      <div className="mx-auto max-w-[1200px]">
        <div className="flex items-end justify-between flex-wrap gap-4">
          ...
          <Link to="/auth" className="text-sm font-semibold text-primary inline-flex items-center gap-1 hover:gap-2 transition-all">
          ...
          {templates.map((t, i) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-4 translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all">
                ...
                <Link to="/auth" className="mt-2 inline-flex items-center gap-1 text-xs font-semibold bg-white text-primary px-3 py-1.5 rounded-lg">
...
function FAQ() {
  const faqs = [
    ...
    { q: "Comment fonctionne le paiement ?", a: "Paiement sécurisé à la création (Wave, Orange Money, carte). Sans abonnement, sans engagement." },
  ];
